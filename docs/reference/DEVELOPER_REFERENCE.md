...
/api/admin/bookings/:id/permanent
/api/admin/bookings/:id/send-ebill
/api/admin/bookings/:id/download-pdf
/api/admin/bookings/calendar
/api/admin/availability/:date
/api/admin/bookings/:id/class-lessons/:lessonId/complete
/api/admin/bookings/:id/class-lessons/:lessonId/cancel
/api/admin/bookings/:id/class-lessons/:lessonId/approve-slot
/api/admin/bookings/:id/class-lessons/:lessonId/reject-slot
/api/admin/bookings/:id/class-lessons/:lessonId/book-slot
/api/admin/users
/api/admin/users/:id
...
/api/admin/revenue
/api/admin/settings
/api/admin/settings/deleted-summary
/api/admin/settings/export-catalog
/api/admin/settings/rental-types/:id
/api/admin/settings/rental-types/:id/permanent
/api/admin/settings/rental-types/:id/restore
/api/admin/settings/bindings/:id
/api/admin/settings/bindings/:id/permanent
/api/admin/settings/bindings/:id/restore
/api/admin/settings/instagram-embeds/:id
/api/admin/settings/instagram-embeds/:id/permanent
/api/admin/settings/instagram-embeds/:id/restore
/api/admin/settings/rental-types/:rentalTypeId/sub-items/:subItemId
/api/admin/settings/rental-types/:rentalTypeId/sub-items/:subItemId/permanent
/api/admin/settings/rental-types/:rentalTypeId/sub-items/:subItemId/restore
...
/api/admin/quotations/saved
/api/admin/quotations/saved/:id
/api/admin/quotations/saved/:id/restore
/api/admin/quotations/saved/:id/permanent
/api/admin/quotations/send
/api/admin/open-events
/api/admin/open-events/:id
/api/admin/open-events/:id/status
/api/admin/open-events/:id/bookings
/api/admin/open-events/:id/notify-users
/api/admin/open-events/:id/test-email
/api/admin/whatsapp-settings
/api/admin/whatsapp-settings/add-contact
/api/admin/whatsapp-settings/update-contact/:index
